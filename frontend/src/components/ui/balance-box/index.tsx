...
const BalanceBox: React.FC<BalanceBoxProps> = ({ balance }) => {
  return (
    <div className="flex items-start justify-center py-4 m-4">
      <div className="relative w-[28rem] h-52 bg-[#9D4EDD] border-4 border-black rounded-2xl flex items-center justify-center text-black p-8 transition-all duration-300 overflow-hidden hover:scale-105 hover:shadow-xl">
